...
export class HomePage {
  ...
  constructor(private _insomnia: Insomnia, private navigationBar: NavigationBar) { 
  ...
  startTimer() {
    ...
    /* Hazlo una vez cuando clickes */
    forwardsTimer();
    backwardsTimer();

    /* Los temporizadores empiezan un segundo despues */
